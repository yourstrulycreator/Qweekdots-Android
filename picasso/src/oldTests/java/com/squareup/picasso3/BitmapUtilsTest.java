...
public class BitmapUtilsTest {
  ...
  @Test public void nullBitmapOptionsIfNoResizingOrPurgeable() {
    // No resize must return no bitmap options_bottom_sheet
  ...
  @Test public void inJustDecodeBoundsIfResizing() {
    // Resize must return bitmap options_bottom_sheet with inJustDecodeBounds = true
  ...
  @Test public void createWithConfigAndNotInJustDecodeBoundsOrInPurgeable() {
    // Given a config, must return bitmap options_bottom_sheet and false inJustDecodeBounds/inPurgeable
