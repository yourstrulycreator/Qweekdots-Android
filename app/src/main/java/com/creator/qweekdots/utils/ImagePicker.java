...
public class ImagePicker extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case UCrop.RESULT_ERROR:
                ...
                Timber.tag(TAG).e("Crop error: %s", cropError);
                setResultCancelled();
                break;
            default:
                setResultCancelled();
    ...
    private void cropImage(Uri sourceUri) {
        ...
        options.setToolbarColor(ContextCompat.getColor(this, R.color.contentBodyColor));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.contentBodyColor));
        options.setActiveWidgetColor(ContextCompat.getColor(this, R.color.contentTextColor));
        options.setToolbarWidgetColor(ContextCompat.getColor(this, R.color.QweekColorAccent));
