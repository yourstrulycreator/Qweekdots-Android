...
import com.creator.qweekdots.snaps.Statics;
...
public class FilterActivity extends AppCompatActivity implements FiltersListFragment.FiltersListFragmentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.snapspicker_filter_title));
        ...
        if (id == R.id.action_open) {
            ...
            if (position != -1) {
                ...
                return true;
                    ...
                    try {
                        Bitmap b = finalImage;
                        File f = File.createTempFile("qpic", ".jpeg", getExternalFilesDir(Environment.DIRECTORY_PICTURES));
                        ...
                        if(SnapsPicker.addresses==null){
                            SnapsPicker.addresses = new ArrayList<>();
                        }
                        SnapsPicker.addresses.add(Uri.fromFile(f).toString());
