...
import com.creator.qweekdots.snaps.filter.FilterActivity;
...
public class MultiSelectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.snapspicker_multi_select_title));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_open) {
            ...
            SnapsPicker.addresses= finalAddresses;
