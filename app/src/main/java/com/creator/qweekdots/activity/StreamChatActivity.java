...
import com.creator.qweekdots.databinding.ActivityStreamBinding;
...
public class StreamChatActivity extends AppCompatActivity {
    private final static String CID_KEY = "key:cid";

    public static Intent newIntent(Context context, Channel channel) {
        final Intent intent = new Intent(context, StreamChatActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ActivityStreamBinding binding = ActivityStreamBinding.inflate(getLayoutInflater());
