...
import com.creator.qweekdots.api.HomeFeedService;
...
public class Spacesfeed extends Fragment implements PaginationAdapterCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.newsfeed1, container, false);
        ...
        feedService = QweekdotsApi.getClient(getContext()).create(HomeFeedService.class);
