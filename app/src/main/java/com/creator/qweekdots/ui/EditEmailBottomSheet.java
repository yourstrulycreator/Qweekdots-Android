...
public class EditEmailBottomSheet extends RoundedBottomSheetDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if(getContext()!=null) {
            ...
            optEmailTxt.addTextChangedListener(new TextWatcher() {
                @Override
                ...
                public void afterTextChanged(Editable s) {
                    saveBtn.setOnClickListener(view1 -> {
                        if(s.length() != 0){
                            ...
                            Toasty.info(requireContext(), "No email? This is the 21st century!", Toast.LENGTH_SHORT).show();
                            stopButtonAnimation();
                        }
                    });
                }
    ...
    private void loadOptEmail() {
        callProfileApi().enqueue(new Callback<ProfileModel>() {
            ...
            public void onResponse(@NotNull Call<ProfileModel> call, @NotNull Response<ProfileModel> response) {
                ...
                optEmailTxt.setText(user.getEmail());
            }
