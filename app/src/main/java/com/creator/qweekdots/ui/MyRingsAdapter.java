...
public class MyRingsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    MyRingsAdapter(Context context, Fragment f, String username, ArrayList<ChatRoom> ringItems) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case RINGS:
                View viewItem = inflater.inflate(R.layout.my_rings_item, parent, false);
                viewHolder = new MyRingsAdapter.RingsVH(viewItem);
                break;
            case LOADING:
                View viewLoading = inflater.inflate(R.layout.item_progress, parent, false);
                viewHolder = new MyRingsAdapter.LoadingVH(viewLoading);
                break;
        }
        return viewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(context!=null) {
            ...
            switch (getItemViewType(position)) {
                ...
                case RINGS:
                    final MyRingsAdapter.RingsVH ringsVH = (MyRingsAdapter.RingsVH) holder;
                ...
                case LOADING:
                    MyRingsAdapter.LoadingVH loadingVH = ( MyRingsAdapter.LoadingVH) holder;
    ...
    */
    ...
    private void add(ChatRoom r) {
        ringItems.add(r);
        notifyItemInserted(ringItems.size() - 1);
    }

    void addAll(ArrayList<ChatRoom> ringItems) {
        for (ChatRoom result : ringItems) {
            add(result);
        }
    }

    private void remove(ChatRoom r) {
