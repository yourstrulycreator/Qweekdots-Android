...
public class ReplyCommentBottomSheet extends RoundedBottomSheetDialogFragment {
    ...
    public ReplyCommentBottomSheet(String drop_id, int parent_id, String username) {
