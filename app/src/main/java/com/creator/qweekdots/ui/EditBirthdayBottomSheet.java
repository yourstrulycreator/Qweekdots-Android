...
public class EditBirthdayBottomSheet extends RoundedBottomSheetDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        //inflating layout
        View view = View.inflate(getContext(), R.layout.edit_birthday_bottom_sheet, null);
        ...
        if(getContext()!=null) {
            ...
            optBirthdayTxt.setLongClickable(false);
            saveBtn = view.findViewById(R.id.optBirthdaySheetSaveButton);
            saveBtn.setClickable(false);

            optBirthdayTxt.addTextChangedListener(new TextWatcher() {
                @Override
                ...
                public void afterTextChanged(Editable s) {
                    saveBtn.setOnClickListener(view1 -> {
                        ...
                        if(s.length() != 0) {
                            ...
                            Toasty.info(requireContext(), "Are you alien born ?", Toast.LENGTH_SHORT).show();
                            stopButtonAnimation();
                        }
                    });
                }
    ...
    private void showDateDialog() {
        ...
        new DatePickerDialog(requireContext(), pickerListener, year, month, day).show();
    }

    // when dialog box is closed, below method will be called.
    private DatePickerDialog.OnDateSetListener pickerListener = (view, selectedYear, selectedMonth, selectedDay) -> {
    ...
    private void updateDate() {
        ...
        optBirthdayTxt.setText(sdf.format(myCalendar.getTime()));
    }
