...
import com.creator.qweekdots.api.PopularFeedService;
...
public class Popularfeed extends Fragment implements PaginationAdapterCallback {
    ...
    private PopularFeedService feedService;

    private String username;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.newsfeed3, container, false);
        ...
        feedService = QweekdotsApi.getClient(getContext()).create(PopularFeedService.class);
