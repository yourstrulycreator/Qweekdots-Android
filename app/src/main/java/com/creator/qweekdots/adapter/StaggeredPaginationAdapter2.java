...
public class StaggeredPaginationAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static final String TAG = StaggeredPaginationAdapter2.class.getSimpleName();

    public StaggeredPaginationAdapter2(Context context, Fragment f, String username) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case FEED:
                View viewItem = inflater.inflate(R.layout.staggered_item2, parent, false);
