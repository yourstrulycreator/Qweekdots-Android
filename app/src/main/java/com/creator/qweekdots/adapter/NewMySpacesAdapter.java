...
public class NewMySpacesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    // View Types
    ...
    public NewMySpacesAdapter(Context context, Fragment f, String username, ArrayList<ChatRoom> ringItems) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case RINGS:
                View viewItem = inflater.inflate(R.layout.flat_my_spaces_item, parent, false);
                viewHolder = new NewMySpacesAdapter.RingsVH(viewItem);
                break;
            case LOADING:
                View viewLoading = inflater.inflate(R.layout.item_progress, parent, false);
                viewHolder = new NewMySpacesAdapter.LoadingVH(viewLoading);
                break;
        }
        return viewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(context!=null) {
            ...
            switch (getItemViewType(position)) {
                case RINGS:
                    final NewMySpacesAdapter.RingsVH ringsVH = (NewMySpacesAdapter.RingsVH) holder;
                ...
                case LOADING:
                    NewMySpacesAdapter.LoadingVH loadingVH = ( NewMySpacesAdapter.LoadingVH) holder;
