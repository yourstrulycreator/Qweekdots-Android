...
import com.creator.qweekdots.adapter.holder.GifNoResultsVH;
import com.creator.qweekdots.adapter.holder.GifSearchItemVH;
import com.creator.qweekdots.adapter.holder.GifSearchPivotsRVVH;
...
public class GifSearchAdapter<CTX extends IGifSearchView>
    ...
    @Override
    public void onBindViewHolder(@NotNull StaggeredGridLayoutItemViewHolder<CTX> viewHolder, int position) {
