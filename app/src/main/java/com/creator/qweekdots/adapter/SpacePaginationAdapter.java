...
public class SpacePaginationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SpacePaginationAdapter(Context context, NewSpaceActivity f, String username) {
