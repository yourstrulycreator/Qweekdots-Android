...
public class CameraView extends FrameLayout implements LifecycleObserver {
    ...
    /**
     * Returns a {@link CameraOptions} instance holding supported options_bottom_sheet for this camera
     * session. This might change over time. It's better to hold a reference from
     * {@link CameraListener#onCameraOpened(CameraOptions)}.
     *
     * @return an options_bottom_sheet map, or null if camera was not opened
     */
    @Nullable
